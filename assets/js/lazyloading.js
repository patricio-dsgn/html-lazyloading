...
let lastBoxll = document.getElementById('boxll'+(initialBoxll-1))
let lastBoxllHeight = lastBoxll.offsetTop
console.log("last boxll height:", lastBoxllHeight)

numberNewBoxll = 4;
console.log("number of new boxll:", numberNewBoxll)
...
window.addEventListener('scroll',function(){
  ...
  const last = pos < lenLogos
  if(scrollTop+clientHeight>=scrollHeight && last){
    for (let i = 0; i < numberNewBoxll; i++) {
      pos = pos + 1
      pos < logos.length ? createPost(pos) : ''
    }
  }
});
